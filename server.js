...
/* ---- Kitchen portal security (4-digit PIN) ----
   Staff enter the kitchen PIN; the server verifies it with a constant-time
   compare and mints an HMAC-signed session token that lasts exactly 24 hours
   (86,400 s). Change the PIN by setting KITCHEN_PIN in render.yaml / your host
   environment (any 4 digits) and redeploy. */
...
/* ---- URL helpers (used for payment/public routes) ---- */
