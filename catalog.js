...
(function (root, factory) {
  ...
  const BRAND = {
    ...
    tz: "Africa/Lagos",
    marketing: {
      headline: "Smokey Party Jollof",
      headlineAccent: "& Authentic Nigerian Flavors",
      sub: "Delivered hot to your door. From smoky party jollof to silky swallow, peppered protein and fresh-pressed drinks — generous plates made fresh every day.",
      cta: "Taste the magic of home today!",
    },
  };
  ...
  /* ---------- Homepage featured selection (strictly capped at 12) ---------- */
  const FEATURED_NAMES = [
    "Cyril's Jollof Rice-FG", "Asun Rice", "Grilled Chicken (Big)", "Asun",
    "Egusi", "Pounded Yam", "Moi Moi", "Glow Drink",
  ];
  const FEATURED = COMBOS.concat(
    MENU.filter(function (m) { return FEATURED_NAMES.indexOf(m.name) !== -1; })
  ).slice(0, 12);
